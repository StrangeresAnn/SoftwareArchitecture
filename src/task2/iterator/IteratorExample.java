package task2.iterator;

import java.util.NoSuchElementException;
/** Паттерн Iterator позволяет последовательно перебирать
 * элементы коллекции без без вникания во внутреннюю структуру и устройство коллекций.
 */
// Интерфейс итератора
...
// Пример пользовательского списка с возможностью перебора элементов с помощью итератора
class CustomList<T> {
